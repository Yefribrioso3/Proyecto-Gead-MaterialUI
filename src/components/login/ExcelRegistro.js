...
const ExcelRegistro = () => {
    ...
    const send = async (item) => {
        ...
        const Excel = item.map((equipo) => {
            return (
                equipo = {
                    Name: equipo[" user "] === undefined ? "No Data Available" : equipo[" user "],
                    LastName: equipo.Apellido === undefined ? "No Data Available" : equipo.Apellido,
                    email: equipo.correo === undefined ? "No Data Available" : equipo.correo,
                    password: "Prueba@1",
                    roleId: 1
                }
            )
