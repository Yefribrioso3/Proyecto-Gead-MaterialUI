...
{/* =============================== */}
                        ...
                        // onChange={handleInputChange} */}
                            ...
                            <div className="col-3">
                                ...
                                />
                                <span className="text-danger text-small d-block mb-2">
                                    {errors.denominacionEquipo && errors.denominacionEquipo.message}
                                </span>
                            ...
                            <div className="col-4">
                                ...
                                >
                                    ...
                                    {lineTypeList.map((elemento) => (
                                        <option value={elemento.Id_LineTypes}>{elemento.Name}</option>
                                    ))
                                    }
                ...
                <section className=" mt-5 pt-5">
                    ...
                    <div className="pt-3 pl-3 pr-3 d-flex " >
                        <div className="me-auto p-2 bd-highlight ml-5">
                            ...
                            <p className="h1Color "><h4>Specifications</h4></p>
                        </div>
                ...
                <section className="pt-5 mt-5">
                    ...
                    <div className=" row d-flex justify-content-center">
                        <div className="col-4">
                            ...
                            <Input type="text" id="dateInstallation" placeholder="Date" size="40" ></Input>
                        </div>
                        <div className="col-4">
                            <label>
                                Desuse reason
                            </label>
                            <Input type="text" id="desuseReason" placeholder="Desuse reason" size="40"></Input>
                        </div>
                    </div>
                    {/* </div> */}
