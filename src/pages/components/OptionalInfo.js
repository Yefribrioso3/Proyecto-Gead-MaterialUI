...
export const OptionalInfo = ( { optionalTechInfo, handleChangeOptionalInfo } ) => {
    ...
    return (
        <>
            ...
            <div className='mb-2'>
                <a className='btn ml-0 mr-4 col-4' onClick={() => OptionalInfoService(!optionalInfoService)} style={{ display: "inline-flex" }} >
                    <h5 className="text-muted">
                        {icon ? <IconButton color="primary" aria-label="edit" component="span">
                            <ArrowDropUp />
                        </IconButton> : <IconButton color="primary" aria-label="edit" component="span">
                            <ArrowDropDown />
                        </IconButton>}
                ...
                optionalInfoService ? (
                    <>
                        <div className='d-flex justify-content-between mb-2 animate__animated animate__fadeInDown'>
                            ...
                            >
                                {
                                    moreOptionalIndo ? <h6 className="text-muted"><ArrowDropUp /> Mostrar menos...</h6> : <h6 className="text-muted"><ArrowDropDown /> Mostrar más...</h6> 
                                }
                            </a>
                            ...
                            >
                                {
                                    moreOptionalIndo ? <h6 className="text-muted"><ArrowDropUp /> Ocultar</h6> : <h6 className="text-muted"><ArrowDropUp /> Mostrar menos...</h6>
                                }
