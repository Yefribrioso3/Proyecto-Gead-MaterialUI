...
const Formulario = ({ data }) => {
  ...
  const handleInputChange = (event) => {
    // Mostrar cada interaccion en la consola
        ...
        <div className="row mb-4 ">
          ...
          <div className="col-5">
            <div className="botonesSave pt-4 mt-3">
              <button className="boton_pers mb-0" type="submit">
        ...
        <div className="row mb-4">
          <div className="col-4">
            <label htmlFor="denominacionEquipo">
              Denominacion del equipo <b className="text-danger">*</b>
            </label>
            <Input
              type="text"
