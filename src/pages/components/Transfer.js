...
import { Button, createTheme, Grid, IconButton, InputAdornment, Paper, Typography } from '@material-ui/core'
            ...
            <Paper style={style.paper}>
                <Grid>
                    <div className='row'>
                        ...
                        <div className='col-9'>
                            ...
                            <Typography style={style.h4}> &nbsp;Transferencias entre plantas</Typography>
                        </div>
                    </div>
                </Grid>
                ...
                <div className='row'>
                    ...
                    <div className='col-4'>
                        ...
                        > Nueva transferencia entre plantas </Button>
                    </div>
                </div>
                {/* ------------------  Tabla   -------------------- */}
                <div>
                    <div style={{ height: 450, width: "100%", backgroundColor: "white", paddingTop: "1rem" }}>
                        <DataGrid
