...
const MasterEquipos = ({ props, valor = false }) => {
  const dataEquipos = [
    {
      ...
      area: "1",
      planta: "Apan",
      equipos: "BOMBA DE COMBUSTOLEO TQ-1 (A)",
      modelnumber: "XC206-2SFP",
      descripcion: "Managed Switch 6 Copper ports + 2 Fiber Optic LC Port",
      emplazam: "",
      OEM: "OEM",
      weight: "",
      current: "",
    ...
    },
    {
      ...
      planta: "Impresur",
      equipos: "TROQUELADORA BOBST",
      modelnumber: "",
      descripcion: "Managed Switch 6 Copper ports",
      emplazam: "",
      OEM: "",
      weight: "",
      current: "",
    ...
    },
    {
      ...
      equipos: "TROQUELADORA BOBST",
      modelnumber: "",
      descripcion: "2 Fiber Optic LC Port",
      emplazam: "",
      OEM: "",
      weight: "",
      current: "",
  ...
  const updateEquipo = (id, updatedEquipo) => {
    setEditing(false);
    setData(
      dataInfo.map((equipo) => (equipo.id === id ? updatedEquipo : equipo))
    ); //Si los id son iguales, mostrara el equipo actualizado, sino seguira mostrando el mismo
  };
  ...
  return (
    <div className="bg-colorBody">
      <h1 className="h1Color ">
        <span className="fa fa-hard-hat ml-4 pl-4 pt-4 mr-3"></span>Maestro de
        equipos
      </h1>
          ...
          <div id="formConentTable ">
            {
              ...
              editing ? (
                ...
                <div>
                  <Formulario addEquipos={addEquipos} dataInfo={dataInfo} />
                </div>
              )
            }
          </div>
