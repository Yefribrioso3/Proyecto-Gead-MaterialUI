...
const ConsultaEquipos = () => {
    ...
    useEffect(() => {
        ...
        Axios.get('http://localhost:3001/api/lineType').then((response) => {
    ...
    const [technicalInformation, setTechnicalInformation] = useState({  //Para guardar informacion tecnica seleccionada a editar
        ...
        SerialNumber: "", vendor: "", currentWorking: '', Id_Equipment: '',
        newTechnicalSpecification: [
            {
                Id_NewTechSpec: '', Id_TechnicalSpecification: '', Name: "", Value: "",
                SelectNewTechSpec: { Id_SelectNewTechSpec: '', Id_TechnicalSpecification: '', Id_NewTechSpec: '' }
    ...
    const [SubArea, setSubArea] = useState({
        Id_SubAreas: '', Name: '', Id_Areas: ''
    })

    const [line, setLine] = useState({
        Id_Line: '', number: '', Id_LineTypes: '',
    })
    ...
    const editar = async (e) => {    //------------- Editar los datos de la tabla en el Modal Editar -------------   
        // let dataNueva = data;
    ...
    const putEquipment = async (Equipo) => {
        ...
        await Axios.put(`http://localhost:3001/api/bu/${Equipo.Procedencia.areas.operations.countries.bu.Id_BU}`, {
            Name: Equipo.Procedencia.areas.operations.countries.bu.Name
        });

        await Axios.put(`http://localhost:3001/api/countries/${Equipo.Procedencia.areas.operations.countries.Id_Countries}`, {
            Name: Equipo.Procedencia.areas.operations.countries.Name,
            Id_BU: Equipo.Procedencia.areas.operations.countries.bu.Id_BU
        });

        await Axios.put(`http://localhost:3001/api/planta/${Equipo.Procedencia.areas.operations.Id_Operations}`, {
            Name: Equipo.Procedencia.areas.operations.Name,
            Id_Countries: Equipo.Procedencia.areas.operations.countries.Id_Countries
        });

        await Axios.put(`http://localhost:3001/api/area/${Equipo.Procedencia.areas.Id_Areas}`, {
            Name: Equipo.Procedencia.areas.Name,
            Id_Operations: Equipo.Procedencia.areas.Id_Operations
        });

        await Axios.put(`http://localhost:3001/api/SubArea/${Equipo.Procedencia.areas.SubArea.Id_SubAreas}`, {
            Name: Equipo.Procedencia.areas.SubArea.Name,
            Id_Areas: Equipo.Procedencia.areas.Id_Areas
        });

        await Axios.put(`http://localhost:3001/api/lineType/${Equipo.Procedencia.line.lineTypes.Id_LineTypes}`, {
            Name: Equipo.Procedencia.line.lineTypes.Name
        });

        await Axios.put(`http://localhost:3001/api/line/${Equipo.Procedencia.line.Id_Line}`, {
            number: Equipo.Procedencia.line.number,
            Id_LineTypes: Equipo.Procedencia.line.lineTypes.Id_LineTypes
        });

        await Axios.put(`http://localhost:3001/api/equipment/${Equipo.Id_Equipment}`, {
            Name: Equipo.Name,
            code: Equipo.code,
            img: Equipo.img,
        ...
        await Axios.put(`http://localhost:3001/api/servicesInformation/${Equipo.ServicesInformation.Id_ServicesInformation}`, {
        ...
        await Axios.put(`http://localhost:3001/api/technicalSpecification/${Equipo.TechnicalSpecification.Id_TechnicalSpecification}`, {
    ...
    const updateNewServInfo = async (NSI) => {
        Axios.put(`http://localhost:3001/api/newServInfo/${NSI.Id_NewServInfo}`, {
    ...
    const updateNewTechSpec = async (NTS) => {
        Axios.put(`http://localhost:3001/api/NewTechInfo/${NTS.Id_NewTechSpec}`, {
    ...
    const eliminar = () => {
        ...
        setGetAllList(getAllList.filter((equipo) => equipo.Id_Equipment !== equipoSeleccionado.Id_Equipment));
    ...
    const abrirModalInsertar = () => {
        ...
        setTechInfoEditado(
            { id: null, technical: '', value: '' }
        );

        setEquipoSeleccionado({  //Hook para controlar el equipo seleccionado
            Id_Equipment: null, Name: '', code: '', img: '', Id_Procedencia: null, Estado: null, createdAt: null, updatedAt: null, Procedencia: {
        ...
        setTechnicalInformation({  //Para guardar informacion tecnica seleccionada a editar
            Id_TechnicalSpecification: null, EquipmentType: '', CurrentConditions: '', Weight: "", OEM: "", Description: "", ModelNumber: "",
            SerialNumber: "", vendor: "", currentWorking: '', Id_Equipment: '',
            newTechnicalSpecification: [
                {
                    Id_NewTechSpec: '', Id_TechnicalSpecification: '', Name: "", Value: "",
    ...
    const sendBu = async (valorInsertar) => {
        await Axios.post("http://localhost:3001/api/bu", {
    ...
    const sendCountry = async (valorInsertar) => {
        await Axios.post('http://localhost:3001/api/countries', {
    ...
    const sendOperations = async (valorInsertar) => {
        await Axios.post('http://localhost:3001/api/planta', {
    ...
    const sendAreas = async (valorInsertar) => {
        await Axios.post('http://localhost:3001/api/area', {
    ...
    const sendSubArea = async (valorInsertar) => {
        await Axios.post('http://localhost:3001/api/SubArea', {
    ...
    const sendlineType = async (valorInsertar) => {
        await Axios.post("http://localhost:3001/api/lineType", {
    ...
    const sendProcedencia = async (valorInsertar) => {
        await Axios.post("http://localhost:3001/api/procedencia", {
    ...
    const sendEquipment = async (valorInsertar) => {
        await Axios.post("http://localhost:3001/api/equipment", {
    ...
    const sendSercivesInformation = async (valorInsertar) => {
        await Axios.post("http://localhost:3001/api/servicesInformation", {
    ...
    const sendTechnicalSpecification = async (valorInsertar) => {
        await Axios.post("http://localhost:3001/api/technicalSpecification", {
    ...
    const sendNewTechnicalSpec = async (valorInsertar) => {
        valorInsertar.TechnicalSpecification.newTechnicalSpecification.map(async (NTS) => {
            await Axios.post("http://localhost:3001/api/NewTechInfo", {
                Id_NewTechSpec: NTS.Id_NewTechSpec,
                Id_TechnicalSpecification: valorInsertar.TechnicalSpecification.Id_TechnicalSpecification,
                Name: NTS.Name,
                Value: NTS.Value
            ...
            await Axios.post("http://localhost:3001/api/selectNewTechSpec", {
                Id_SelectNewTechSpec: NTS.SelectNewTechSpec.Id_SelectNewTechSpec,
                Id_TechnicalSpecification: valorInsertar.TechnicalSpecification.Id_TechnicalSpecification,
                Id_NewTechSpec: NTS.Id_NewTechSpec
            })
    ...
    const onSubmitTechSpech = async (data, e) => {
        ...
        const newTechnicalSpec = {
            Id_NewTechSpec: data.Id_NewTechSpec,
            Id_TechnicalSpecification: equipoSeleccionado.TechnicalSpecification.Id_TechnicalSpecification,
            Name: data.Name,
            Value: data.Value,
            SelectNewTechSpec: {
                Id_SelectNewTechSpec: uuidv4(),
    ...
    const eliminarAddTechInfo = async (id) => {
        ...
        const idSelectNewTechSpec = equipoSeleccionado.TechnicalSpecification.newTechnicalSpecification.find(nts => nts.Id_NewTechSpec === id)
        const idSelectNewTech = idSelectNewTechSpec.SelectNewTechSpec.Id_SelectNewTechSpec
    ...
    const deleteNewTechnicalSpec = async (id, idSelectNewTech) => {
        ...
        await Axios.delete(`http://localhost:3001/api/selectNewTechSpec/${idSelectNewTech}`)
        // .then((id) => {
        //     console.log(idSelectNewTech)
        //     alert("SelectNewTech Deleted");
        // });

        await Axios.delete(`http://localhost:3001/api/NewTechInfo/${id}`)
            .then((id) => {
                console.log(id)
    ...
    const update = (equipo) => {    //  Elimina New Services Information
    ...
    const [techInfoEditado, setTechInfoEditado] = useState({  //Para guardar informacion tecnica seleccionada a editar
        Id_NewServInfo: null, Id_ServicesInformation: null, Name: '', Value: ''
    });

    const [technicalSpecEditado, setTechnicalSpecEditado] = useState({  //Para guardar informacion tecnica seleccionada a editar
        Id_NewTechSpec: null, Id_TechnicalSpecification: null, Name: '', Value: ''
    });
    ...
    const editRow = (techInfo, caso) => {   //Capturar informacion tecnica seleccionada en variable
        setEditingTechInfo(true);

        (caso === 'technical') ? (
            setTechnicalSpecEditado({
                Id_NewTechSpec: techInfo.Id_NewTechSpec, Id_TechnicalSpecification: techInfo.Id_TechnicalSpecification,
                Name: techInfo.Name, Value: techInfo.Value
            })

        ) : (
            setTechInfoEditado({
                Id_NewServInfo: techInfo.Id_NewServInfo, Id_ServicesInformation: techInfo.Id_ServicesInformation,
                Name: techInfo.Name, Value: techInfo.Value
            })
        )
    }
    ...
    const updateAddServInfo = async (id, updatedTechInfo, e) => {  //Editar o actualizar informacion tecnica seleccionada
        setEditingTechInfo(false);
    ...
    const updateAddTechInfo = async (id, updatedTechInfo, e) => {  //Editar o actualizar informacion tecnica seleccionada
        setEditingTechInfo(false);
        let NewEquipment = equipoSeleccionado;
    ...
    const filtrarBUList = async (bu, n) => {
        ...
        if (contador === 0) {
            setList(list)
            setGetAllList(getAllList.filter((equipo) => equipo.Procedencia.areas.operations.countries.bu.Name === bu))
            setContador(++counter)
        } else {
        ...
        <div >
                        ...
                        <div>
                            ...
                            <ModalBody className="row text-align-center  animate__animated animate__fadeIn" >
                                ...
                                <FormGroup >
                                    ...
                                    <div id="imagen" className="card animate__animated animate__fadeInLeft" style={{ maxWidth: 380 }}>
                                        {/* ms-5 */}
                                        {
                                            loading ? (
                                                <h3>Loading...</h3>
                                                ...
                                                <>
                                                    <img src={equipoSeleccionado.img} style={{ width: '380px' }} />
                                                </>
                                            )
                                        }
                                    </div>

                                    <div id="imagen" className="card mt-2 animate__animated animate__fadeInLeft" style={{ maxWidth: 380 }}>
                                        {/* ms-5 */}
                                        <input
                                            type="file"
                                            name="file"
            ...
            < Modal isOpen={modalEliminar} >
                <ModalBody className="text-center">
                    Estás seguro que deseas eliminar el equipo: <br />{equipoSeleccionado && equipoSeleccionado.Name}
                </ModalBody>
            ...
            < Modal isOpen={modalInsertar} style={{ maxWidth: 800 }}>
                        ...
                        <div>
                            ...
                            <form>
                                <ModalBody className="row text-align-center animate__animated animate__fadeIn">
                                    ...
                                    <FormGroup >
                                        {/* -------------------------       Subir Imagen        ------------------ */}
                                        <div id="imagen" className=" animate__animated animate__fadeInLeft" style={{ maxWidth: 380, alignContent: 'center' }}>
                                            {
                                                loading ? (
                                                    <h3>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                                        ...
                                        <div id="imagen" className="mt-2 animate__animated animate__fadeInLeft" style={{ maxWidth: 60, alignContent: 'center' }}>
                                            {/* ms-5 */}

                                            <input accept="image/*" id="icon-button-file"
                                                type="file" style={{ display: 'none' }} onChange={uploadImage} />
                ...
                <ModalFooter>
                    <Button color='primary' type="submit" onClick={() => insertar()}>Aceptar</Button>
                    <Button color='danger'
                        onClick={() => {
                            setModalInsertar(false)
                            seteditingNewServInfo(true);
